...
(function (l) {
    ...
    function Kb(a) {
        var b = a.oClasses,
            ...
            f =
                ...
                b.sFilterInput +
                '" style="float: right; padding-top: 0.25em; padding: 5px;"/>',
            g = d.sSearch;
    ...
    l.extend(u.ext.classes, {
        ...
        sStripeOdd: "odd",
        sStripeEven: "even",
        sRowEmpty: "mt-0.5 text-slate-500 text-center",
        sWrapper: "dataTables_wrapper",
        sFilter: "dataTables_filter",
        sInfo: "mt-0.5 text-slate-500",
        ...
        sFilterInput: "form-control w-56 box",
        sLengthSelect: "w-20 form-select col-span-1 box mt-3 sm:mt-0",
...
(function (a) {
    ...
    a.extend(d.ext.classes, {
        ...
        sFilterInput: "form-control form-control-sm w-56",
        sLengthSelect: "form-select form-select-sm w-20",
